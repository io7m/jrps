...
package com.io7m.jrps.core;

import java.util.Objects;

/**
 * The type of exceptions raised by the various modules of the project.
 */

public abstract class JRPSException extends RuntimeException
{
  /**
